...
public class AuthenticationService {
	...
	//Authentication manager that verifies user credentials
	@Autowired
	...
	//Check if normal user is already present if not then create a new user, and assign role with the registerDTO set fields
	...
	//Check if admin is already present if not then create a new user, and assign role with the registerDTO set fields
